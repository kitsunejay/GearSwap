...
function user_setup()
    ...
    state.Gun = M{['description']='Current Gun','Fomalhaut','Death Penalty','Anarchy +2'}
...
function init_gear_sets()
    ...
    sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
        ...
        body="Lanun Frac +2",hands="Carmine Finger Gauntlets +1",ring1="Dingir Ring",ring2="Ilabrat Ring",
    ...
    sets.precast.WS['Aeolian Edge'] = {
        ...
        body="Lanun Frac +2",hands="Carmine Finger Gauntlets +1",ring1="Dingir Ring",ring2="Shiva Ring +1",
        back=gear.camulus_mwsd,waist="Eschan Stone",legs=gear.herc_legs_mabwsd,feet="Lanun Bottes +3"}
    ...
    sets.midcast.FastRecast = {
        ...
        body="Adhemar Jacket +1",hands="Leyline Gloves",
    ...
    sets.midcast.CorsairShot.Acc = {ammo=gear.QDbullet,
        ...
        body="Mummu Jacket +2",hands="Mummu Wrists +2",ring1="Stikini Ring +1",ring2="Sangoma Ring",
    ...
    sets.midcast.RA = {ammo=gear.RAbullet,
        ...
        body="Mummu Jacket +2",hands="Adhemar Wristbands +1",ring1="Dingir Ring",ring2="Ilabrat Ring",
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        body="Lanun Frac +2",hands="Meghanada Gloves +2",ring1="Defending Ring",ring2="Vocane Ring",
    ...
    sets.idle.Town = {ammo=gear.RAbullet,
        ...
        body="Lanun Frac +2",hands="Lanun Gants +3",ring1="Dingir Ring",ring2="Archon Ring",
        back=gear.camulus_tp,waist="Eschan Stone",legs="Carmine Cuisses +1",feet="Lanun Bottes +3"}
    
    -- Defense sets
    sets.defense.DT = {
        head="Meghanada Visor +2",neck="Loricate Torque +1",ear1="Enervating Earring",ear2="Telos Earring",
        body="Meghanada Cuirie +2",hands="Meghanada Gloves +2",ring1="Defending Ring",ring2="Vocane Ring",
