...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Ginsen",
        ...
        body="Phorcys Korazin",hands="Flamma Manopolas +1",ring1="Flamma Ring",ring2="Apate Ring",
        back="Smertrios's Mantle",waist="Fotia Belt",legs="Valorous Hose",feet="Flamma Gambieras +1"}
