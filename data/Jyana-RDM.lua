...
function init_gear_sets()
    ...
    sets.idle = {main="Raetic Staff +1",sub="Enki Strap",ammo="Homiliary",
        head="Vitiation Chapeau +3",neck="Twilight Torque",ear1="Etiolation Earring",ear2="Genmei Earring",
    ...
    sets.idle.PDT = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        head="Atrophy Chapeau +2",neck="Twilight Torque",ear1="Thureous Earring",ear2="Genmei Earring",
