...
function init_gear_sets()
    ...
    sets.precast.FC = {
        main="Solstice", -- 5
		range="Dunna",
        head=gear.head.Vanya.HealingMagicSkill,
		ear2="Etiolation Earring", -- 1
        back="Lifestream Cape", -- 7
		ring2="Kishar Ring",
        legs="Geomancy Pants +3", -- 15
        feet=gear.feet.Merlinic.Refresh -- 5
    }
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC, {
		...
		body=gear.body.Vanya.HealingMagicSkill,
		hands=gear.hands.Vanya.HealingMagicSkill,
		feet=gear.feet.Vanya.HealingMagicSkill
    })
    ...
    sets.midcast.Geomancy = {
        ...
        hands="Geomancy Mitaines +3", -- 19
        body="Bagua Tunic +1", -- 12
        back="Lifestream Cape", -- 11
    }

    sets.midcast.Geomancy.Indi = set_combine(sets.midcast.Geomancy, {
		main="Solstice", -- 15
		neck="Bagua Charm +2",
        legs="Bagua Pants +1", -- 15
        feet="Azimuth Gaiters", -- 20
        back="Lifestream Cape", -- 12
    })

    sets.midcast.Cure = set_combine(sets.midcast.FastRecast, {
		main="Vadose Rod",
        head=gear.head.Vanya.HealingMagicSkill, -- +10%, 20 skill
        ear1="Mendicant's Earring", -- +5%
		neck="Phalaina Locket", -- 4%
		body=gear.body.Vanya.HealingMagicSkill, -- 20 skill
		hands=gear.hands.Vanya.HealingMagicSkill, -- 20 skill
		feet=gear.feet.Vanya.HealingMagicSkill -- 5%, 20 skill
    })
    ...
    sets.midcast.LowTierNuke = sets.midcast.HighTierNuke
    
    sets.midcast.LowTierNuke.Resistant = sets.midcast.LowTierNuke

    sets.midcast.Macc = set_combine(sets.midcast.HighTierNuke, {
        neck="Bagua Charm +2",
    ...
    sets.idle = {
        ...
        --feet=gear.feet.Merlinic.Refresh
        feet="Geomancy Sandals +3"
    }
