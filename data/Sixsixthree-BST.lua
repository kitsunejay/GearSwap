...
function init_gear_sets()
    ...
    sets.buff['Sneak Attack'] = {ammo="Yetshila +1",
        ...
        back="Sacro Mantle",waist="Grunfeld Rope",legs="Pillager's Culottes +3",feet="Plunderer's Poulaines +1"}
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS,{
        ...
        legs=gear.herc_legs_mab,waist="Grunfeld Rope",feet="Nyame Sollerets",
    })
    ...
    sets.midcast.FastRecast = {
        ...
        back="Sacro Mantle",waist="Ninurta's Sash",legs="Malignance Tights",feet="Herculean Boots"}

    -- Specific spells

    -- Ranged gear
    sets.midcast.RA = {
        head="Malignance Chapeau",neck="Anu Torque",ear1="Telos Earring",ear2="Enervating Earring",
    ...
    sets.defense.DT = {ammo="Staunch Tathlum +1",
        ...
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Gelatinous Ring +1",
        back="Sacro Mantle",waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
